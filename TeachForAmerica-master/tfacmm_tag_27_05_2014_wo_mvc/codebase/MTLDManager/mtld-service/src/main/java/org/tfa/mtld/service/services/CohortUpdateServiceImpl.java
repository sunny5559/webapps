...
public class CohortUpdateServiceImpl implements CohortUpdateService {
	 ...
	 */
	@Override
	public CohortBean addCMToCohort(
			Map<String, List<CriteriaBean>> criteriaMap, boolean isUnhired,
			int corpsMemberId, int cohortId, List<CriteriaBean> criteriaBeanList)
		...
		cohortService.scoreCohortList(cohortList, criteriaBeanList);
	...
	public CohortBean saveUpdatedCohort(int cohortId,
			Map<String, List<CriteriaBean>> criteriaMap, String loginId)
			throws TFAInvalidCohortException, Exception {
