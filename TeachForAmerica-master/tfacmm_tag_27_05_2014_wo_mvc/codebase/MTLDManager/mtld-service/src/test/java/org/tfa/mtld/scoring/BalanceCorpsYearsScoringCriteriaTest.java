...
public class BalanceCorpsYearsScoringCriteriaTest {
	...
	public void testEmptyCohort() {
		CorpsMember cm = createCm(1000, TFAConstants.CORPS_YEAR1);
	...
	public void testCohortWithMoreFirstYears() {
		Cohort cohort = new Cohort();
		CorpsMember cm1y1 = createCm(1001, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm2y1 = createCm(1002, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm3y1 = createCm(1003, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm4y1 = createCm(1004, TFAConstants.CORPS_YEAR1, cohort);
	...
	public void testImbalancedCohort() {
		...
		CorpsMember cm3y1 = createCm(1003, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm4y1 = createCm(1004, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm5y1 = createCm(1005, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm6y1 = createCm(1006, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm7y1 = createCm(1007, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm8y1 = createCm(1008, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm9y1 = createCm(1009, TFAConstants.CORPS_YEAR1, cohort);
	...
	public void testLargeCohort() {
		...
		CorpsMember cm8y1 = createCm(1008, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm9y1 = createCm(1009, TFAConstants.CORPS_YEAR1, cohort);
		CorpsMember cm10y1 = createCm(1010, TFAConstants.CORPS_YEAR1, cohort);
