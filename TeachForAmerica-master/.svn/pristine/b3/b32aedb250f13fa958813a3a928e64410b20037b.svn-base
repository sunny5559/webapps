...
public class MTLDBean extends Address{
	...
	private String corpsRegionName;

	private String corpsSchoolDistrict;

	//Added by Divesh Solanki for export/export
	...
	//Added by Divesh Solanki for export/export
	//This field hold the region code value of region to which MTLD currently belonging
	private String regionCode;
	
	private Set<MTLDSchoolBean> mtldSchoolBean;
	
	public Set<MTLDSchoolBean> getMtldSchoolBean() {
		return mtldSchoolBean;
	}

	public void setMtldSchoolBean(Set<MTLDSchoolBean> mtldSchoolBean) {
		this.mtldSchoolBean = mtldSchoolBean;
	}
	...
	public String getCorpsSchoolDistrict() {
		return corpsSchoolDistrict;
	}

	public void setCorpsSchoolDistrict(String corpsSchoolDistrict) {
		this.corpsSchoolDistrict = corpsSchoolDistrict;
	}

	public String getCorpsRegionName() {
		return corpsRegionName;
	}

	public void setCorpsRegionName(String corpsRegionName) {
		this.corpsRegionName = corpsRegionName;
	}
	...
	public void setPlacementAdvisorTfaId(String placementAdvisorTfaId) {
		this.placementAdvisorTfaId = placementAdvisorTfaId;
	}
