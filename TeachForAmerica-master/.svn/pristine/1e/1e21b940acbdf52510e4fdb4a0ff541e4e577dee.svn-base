...
public class MTLDPriorSchoolPlacementScoringCriteriaTest {
	...
	public void testMatchMTLDToSingleCorpsMember() {
		...
		MTLDSchool mtldschool1 = createMTLDSchool(mtld,school1);
		MTLDSchool mtldschool2 = createMTLDSchool(mtld,school2);
		...
		mtld.setPriorSchoolsWorked(new HashSet<MTLDSchool>());
		assertEquals(0.0, criteria.scoreMtldToCorpsMember(mtld, cm), 0.0);

		cm.setSchool(null);
		mtld.getPriorSchoolsWorked().add(mtldschool1);
		assertEquals(0.0, criteria.scoreMtldToCorpsMember(mtld, cm), 0.0);
	...
	private MTLDSchool createMTLDSchool(MTLD mtld, School school) {
	...
	public void testMatchMTLDToEmptyCohort() {
		...
		MTLDSchool mtldschool1 = createMTLDSchool(mtld,school);
	...
	public void testMatchMTLDToCohort() {
		...
		MTLDSchool mtldschool3 = createMTLDSchool(mtld,school3);
		MTLDSchool mtldschool1 = createMTLDSchool(mtld,school1);
		...
		mtld.setPriorSchoolsWorked(new HashSet<MTLDSchool>());
		mtld.getPriorSchoolsWorked().add(mtldschool3);
		assertEquals(0.0, criteria.scoreMtldToCohort(mtld, cohort), 0.0);
