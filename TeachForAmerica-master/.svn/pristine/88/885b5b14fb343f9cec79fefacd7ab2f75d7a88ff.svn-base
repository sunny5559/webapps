		...
		//End: Show Cohort Details
		 ...
		 $(document).on('click', '.open_mtld', function (e) {
			 ...
			 $("#mtld_cmo_affiliation_"+fieldId).val().length==0 || $("#mtld_cmo_affiliation_"+fieldId).val()=="null"?$(".mtld_cmo_affiliation").html(NO_RECORD_FOUND)+$(".mtld_cmo_affiliation").css("color","gray"):$(".mtld_cmo_affiliation").css("color","black")+$(".mtld_cmo_affiliation").html($("#mtld_cmo_affiliation_"+fieldId).val());
				...
				$("#mtld_alum_"+fieldId).val().length==0 || $("#mtld_alum_"+fieldId).val()=="null"?$(".mtld_alum").html(NO_RECORD_FOUND)+$(".mtld_alum").css("color","gray"):$(".mtld_alum").css("color","black")+$(".mtld_alum").html($("#mtld_alum_"+fieldId).val());
				...
				$("#mtld_person_color_"+fieldId).val().length==0 || $("#mtld_person_color_"+fieldId).val()=="null"?$(".mtld_person_color").html(NO_RECORD_FOUND)+$(".mtld_person_color").css("color","gray"):$(".mtld_person_color").css("color","black")+$(".mtld_person_color").html($("#mtld_person_color_"+fieldId).val());
				$("#mtld_low_income_background_"+fieldId).val().length==0 || $("#mtld_low_income_background_"+fieldId).val()=="null"?$(".mtld_low_income_background").html(NO_RECORD_FOUND)+$(".mtld_low_income_background").css("color","gray"):$(".mtld_low_income_background").css("color","black")+$(".mtld_low_income_background").html($("#mtld_low_income_background_"+fieldId).val()=="0"?"N":"Y");
