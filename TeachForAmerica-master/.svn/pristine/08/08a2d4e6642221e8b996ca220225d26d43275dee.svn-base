...
public class MtldCmRepositoryImpl implements MtldCmRepository {
	...
	public List<CorpsMember> getCorpMemberListByRegionId(Integer regionId)
		...
		logger.info("In getCorpMemberListByRegionIdr in time " + System.currentTimeMillis());
		...
		logger.info("Out getCorpMemberListByRegionId executin time taken " + timeDiff);
		return corps;
	}
	...
	public List<MTLD> getMTLDListByRegionId(Integer regionId) throws Exception {
		long startTime = System.currentTimeMillis();
		logger.info(" In getMTLDListByRegionId(Integer regionId) in time " + System.currentTimeMillis());
		...
		long endTime = System.currentTimeMillis();
		long timeDiff = endTime - startTime;
		logger.info("Out getMTLDListByRegionId(Integer regionId) executin time taken " + timeDiff);
		return mtlds;
	...
	public List<MTLD> getMTLDList() throws Exception {
		...
		try {
			session = sessionFactory.openSession();
			Query query = (Query) session.createQuery("from MTLD ");
	...
	public void updateMTLDLatLong(MTLD mtld) throws Exception {
		long startTime = System.currentTimeMillis();
		logger.info("In updateMTLDLatLong in time " + System.currentTimeMillis());
		Session session = null;
		Transaction tx = null;
		try {
			session = sessionFactory.openSession();
	...
	public List<CorpsMember> getUnhiredCorpMemberListByRegionId(Integer regionId)
			throws Exception {
		long startTime = System.currentTimeMillis();
		logger.info("In getUnhiredCorpMemberListByRegionId in time " + System.currentTimeMillis());
		List<CorpsMember> corps = null;
		Session session = null;
		try {
			session = sessionFactory.openSession();
		...
		long endTime = System.currentTimeMillis();
		long timeDiff = endTime - startTime;
		logger.info("Out getUnhiredCorpMemberListByRegionId executin time taken " + timeDiff);
		return corps;
	}
	...
	public List<CorpsMember> getHiredCorpMemberListByRegionId(Integer regionId)
			throws Exception {
		long startTime = System.currentTimeMillis();
		logger.info("In getHiredCorpMemberListByRegionId(Integer regionId) in time " + System.currentTimeMillis());
		List<CorpsMember> corps = null;
		Session session = null;
		try {
			session = sessionFactory.openSession();
		...
		long endTime = System.currentTimeMillis();
		long timeDiff = endTime - startTime;
		logger.info("Out getHiredCorpMemberListByRegionId(Integer regionId) executin time taken " + timeDiff);
		return corps;
	}
	...
	public List<Cohort> getCohortListByRegionId(Integer regionId)
			throws Exception {
		long startTime = System.currentTimeMillis();
		logger.info("In getCohortListByRegionId in time " + System.currentTimeMillis());
		Session session = null;
		List<Cohort> cohorts = null;
		try {
			session = sessionFactory.openSession();
			/*String sql = "select * from cohort where is_final_cohort=1 and region_id = :regionId";
			SQLQuery query = session.createSQLQuery(sql).addEntity(Cohort.class);*/
			Query query = (Query) session
		...
		long endTime = System.currentTimeMillis();
		long timeDiff = endTime - startTime;
		logger.info("Out getCohortListByRegionId executin time taken " + timeDiff);
		return cohorts;
	}
	...
	@Override
	@Transactional(readOnly = true)
	public void saveCohort(List<Cohort> cohortListToSave) throws Exception {
		long startTime = System.currentTimeMillis();
		...
		try {
			session = sessionFactory.openSession();
			tx = session.beginTransaction();
			/*for (Cohort cohort : cohortListToSave) {
	...
	public CorpsMember getCorpsMemberById(int corpsId) throws Exception {
		long startTime = System.currentTimeMillis();
		logger.info("In getCorpsMemberById in time " + System.currentTimeMillis());
		Session session = sessionFactory.openSession();
	...
	public void flushUnfinalizeCohort(Integer regionId) throws Exception {
		long startTime = System.currentTimeMillis();
		logger.info("In flushUnfinalizeCohort in time " + System.currentTimeMillis());
		Session session = null;
		try {
			session = sessionFactory.openSession();
	...
	public void deleteCohortDetail(CohortDetail cohortDetail) throws Exception {
		long startTime = System.currentTimeMillis();
		logger.info("In deleteCohortDetail in time " + System.currentTimeMillis());
		Session session = null;
		Transaction tx = null;
		try {
			session = sessionFactory.openSession();
	...
	public MTLD getMTLDById(int mtldId) throws Exception {
		long startTime = System.currentTimeMillis();
		logger.info("In getMTLDById(int mtldId) in time " + System.currentTimeMillis());
		Session session = sessionFactory.openSession();
		MTLD mtld = null;
		try {
			mtld = (MTLD) session.load(MTLD.class, mtldId);
		...
		long endTime = System.currentTimeMillis();
		long timeDiff = endTime - startTime;
		logger.info("Out getMTLDById(int mtldId) executin time taken " + timeDiff);
		return mtld;
	}
		...
		try {
			...
			if (existingCorps != null && existingCorps.size() > 0) {
				CorpsMember existingCorpsMember = (CorpsMember) existingCorps
						.get(0);
				if (existingCorpsMember.getRegion().getRegionId() == corps.getRegion().getRegionId()) {
